...
| `email-verification-requested` | ✅ Implemented | Auth.Api | Notification.Api | [v1](../../contracts/events/email-verification-requested.v1.md) |
| `password-change-code-requested` | ✅ Implemented | Auth.Api | Notification.Api | [v1](../../contracts/events/password-change-code-requested.v1.md) |
| `partner-transaction` | ✅ Implemented | Auth.Api | Notification.Api | [v1](../../contracts/events/partner-transaction.v1.md) |
