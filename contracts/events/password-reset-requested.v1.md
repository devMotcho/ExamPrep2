# `password-reset-requested` (v1)

Published by `Auth.Api` when a user requests a password reset. Consumed by `Notification.Api` to dispatch an email containing the OTP code.
